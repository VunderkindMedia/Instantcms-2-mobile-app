...
<!-- [![github release](https://img.shields.io/github/release/archriss/react-native-render-html-fix.svg?style=flat-square)](https://github.com/archriss/react-native-render-html-fix/releases) -->
...
`npm install react-native-render-html-fix --save` or `yarn add react-native-render-html-fix`
